...
export default function HomePage() {
    return (
        <div className="flex min-h-screen flex-col space-y-10 bg-background">
            <h1 className="md:text-8xl text-4xl font-semibold text-foreground text-center md:mt-20 mt-10">
                Streamline your Insta-Sales<br/> with <span className={"underline text-indigo-500"}>Lumoflo</span>
            </h1>
            ...
            <section id={"features"}>
                ...
                <div className={"grid grid-cols-4 gap-5 my-5"}>
                    <div className={"col-span-1 border bg-gray-500/10 p-4 rounded"}>
                    ...
                    <div className={"col-span-2 border bg-gray-500/10 p-4 rounded"}>
                    ...
                    <div className={"col-span-1 row-span-2 border bg-gray-500/10 p-4 rounded"}>
                        <h2 className={"text-4xl -ml-2"}>🚚</h2>
            ...
            <section id={"features"}>
                ...
                <Accordion type="single" collapsible className="w-full max-w-screen-sm mx-auto my-10">
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                            Lumoflo is an all-in-one platform crafted to streamline Instagram selling. It simplifies order management, logistics, and payments for sellers, ensuring a seamless selling experience.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                        <AccordionTrigger>Why was Lumoflo created?</AccordionTrigger>
                        <AccordionContent>
                            Lumoflo was born to ease the complexities of Instagram sales. It centralizes operations, empowering sellers with tools for efficient order management and streamlined processes.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                        <AccordionTrigger>How will Lumoflo help Instagram sellers?</AccordionTrigger>
                        <AccordionContent>
                            Lumoflo simplifies selling by offering an intuitive interface for order management, logistics coordination, and secure payment processing, tailored specifically for Instagram sellers.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-4">
                        <AccordionTrigger>How are logistics handled on Lumoflo?</AccordionTrigger>
                        <AccordionContent>
                            Lumoflo collaborates with logistics partners, enabling seamless pickups, real-time shipment tracking, and efficient management, simplifying the entire process for sellers.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-5">
                        <AccordionTrigger>How are payments managed on Lumoflo?</AccordionTrigger>
                        <AccordionContent>
                            Lumoflo seamlessly integrates Razorpay payment gateway for automated transactions. Sellers have the choice to manually accept payments to avoid convenience charges, providing flexibility in payment methods.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-6">
                        <AccordionTrigger>When will Lumoflo launch?</AccordionTrigger>
                        <AccordionContent>
                            Lumoflo's launch date will be unveiled soon. Keep an eye out for official announcements regarding the launch!
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </section>
