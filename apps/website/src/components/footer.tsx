...
const Footer = () => {
    return (
        <footer className="w-full bg-gray-500/10 ">
            <hr className={"border-px w-full"}/>
            <div className="mx-auto px-4 py-16 sm:px-6 lg:px-8">
                <div className="flex justify-center text-teal-600">
                    <img src="/cl_logo.svg" className="h-8" alt="Logo"/>
                </div>

                <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
                    Empowering Instagram sellers with streamlined solutions for seamless selling experiences.<br/>
